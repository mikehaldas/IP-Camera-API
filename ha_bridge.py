...
CONFIG_FILE = os.path.join(BASE_DIR, "ha_bridge.yaml")
IMG_DIR = os.path.join(BASE_DIR, "ha_images")
...
def load_config():
    ...
    if not os.path.exists(CONFIG_FILE):
        ...
        print(f"Copy ha_bridge.yaml.example to ha_bridge.yaml and configure it.")
        sys.exit(1)
